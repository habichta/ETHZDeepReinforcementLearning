...
cp /home/pdinesh/knet-euryale/models/params_ms_euryale.json /home/pdinesh/exp_logs/$exp_name.json


sbatch --nodelist=node[$node] --gres="gpu" --job-name=$exp_name --output=$exp_logs$exp_name".out" --error=$exp_logs$exp_name".out" $euryale"/"sbatch_predict_ms_daily.sh
