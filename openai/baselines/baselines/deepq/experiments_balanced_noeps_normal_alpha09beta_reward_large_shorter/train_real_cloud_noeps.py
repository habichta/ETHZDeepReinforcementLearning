...
def main():
    ...
    env =   RealCloudEnvironmentNoEps(data_path,img_path,train_set_path, image_size=img_size,
                ...
                file="rl_data_sp.csv",mask_path=mask_path,exploration_follow="IRR",start_exploration_deviation=0.1,clip_irradiance=False)
    ...
    act = deepq.learn(
        ...
        train_freq=4,
        learning_starts=int(buffer_size/2),
        target_network_update_freq=1000,
        gamma=0.99,
        prioritized_replay=True,
        prioritized_replay_alpha=0.9,
        prioritized_replay_beta0=0.1,
        prioritized_replay_beta_iters=None,
        reward_priority=True,
