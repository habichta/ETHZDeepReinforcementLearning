...
from cloud_environment_real_noeps import RealCloudEnvironmentNoEps
import numpy as np
import collections
import os
import csv
...
def main():
    ...
    data_path="/media/data/Daten/data_C_int/"
    mask_path="/media/data/Daten/img_C/cavriglia_skymask256.png"
    img_path="/media/data/Daten/img_C/"
    ...
    env =   RealCloudEnvironmentNoEps(data_path,img_path,train_set_path, image_size=img_size,
                 sequence_length=seq_length, sequence_stride=seq_stride, action_nr=7, action_type=1, ramp_step=0.1, episode_length_train=200,
                file="rl_data_sp.csv",mask_path=mask_path,exploration_follow="IRR",start_exploration_deviation=0.2,clip_irradiance=True)
