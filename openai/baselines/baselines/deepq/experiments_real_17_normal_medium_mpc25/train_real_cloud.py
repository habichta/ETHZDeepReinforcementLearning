...
def main():
    ...
    data_path = "/home/nox/Masterarbeit/data/Daten/data_C_int/"
    mask_path = "/home/nox/Masterarbeit/data/Daten/img_C/cavriglia_skymask256.png"
    img_path = "/home/nox/Masterarbeit/data/Daten/img_C/"
    ...
    env =   RealCloudEnvironment(data_path,img_path,train_set_path, image_size=img_size,
                ...
                file="rl_data_sp.csv",load_train_episodes="ep17_200.pkl",mask_path=mask_path,sample_training_episodes=None,exploration_follow="MPC",start_exploration_deviation=0.2,clip_irradiance=False)
    ...
    act = deepq.learn(
        ...
        load_cpk='/home/nox/Masterarbeit/shared/dlabb/openai/baselines/baselines/deepq/experiments_real_17_normal_medium_mpc25/tmplap8b_qq/model',
        mpc_guidance=0.25
