...
def main():
    ...
    env =   RealCloudEnvironment(data_path,img_path,train_set_path, image_size=img_size,
                ...
                file="rl_data_sp.csv",load_train_episodes="ep600_200.pkl",mask_path=mask_path,sample_training_episodes=None,exploration_follow="IRR",start_exploration_deviation=0.2,clip_irradiance=False)
