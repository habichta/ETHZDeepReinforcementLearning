...
def main():
    ...
    env =   RealCloudEnvironmentNoEps(data_path,img_path,train_set_path, image_size=img_size,
                 sequence_length=seq_length, sequence_stride=seq_stride, action_nr=2, action_type=3, ramp_step=0.1, episode_length_train=200,
                file="rl_data_sp.csv",mask_path=mask_path,exploration_follow="IRR",start_exploration_deviation=0.3,clip_irradiance=True)
